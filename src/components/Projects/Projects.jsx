  ...
  return (
    <div className='projects-container'>
        <div className="project" id='upcoming-project'onClick={()=>{
            ...
            document.getElementsByClassName('project')[0].style.textOrientation = ''
            ...
            document.getElementsByClassName('project')[1].style.textOrientation = 'upright'
            ...
            document.getElementsByClassName('project')[2].style.textOrientation = 'upright'
        ...
        style={
            ...
            <p><span className='project-bold'>Upcoming</span><br />Projects</p>
        </div>
        <div className="project" id='ongoing-project' onClick={()=>{
            ...
            document.getElementsByClassName('project')[1].style.textOrientation = ''
            ...
            document.getElementsByClassName('project')[0].style.textOrientation = 'upright'
